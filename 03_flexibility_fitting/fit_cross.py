...
if Flag_RD == 'True':
    ...
    params_fit = glmnet_python.glmnet(x = X_array.copy(), y = forces_energies.copy(),family = 'gaussian',alpha = 1, nlambda = 100, thresh = 1e-10, cl = c1_final, penalty_factor = PF_final, weights = weights ,standardize = False, standardize_resp = False, lambda_min = np.array([1e-5]), intr = False)   
